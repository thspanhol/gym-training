...
function CreateTraining() {
  ...
  return (
    <Create>
      <Title>
        Crie Seu <span>Treino!!</span>
      </Title>
      <img
        src="https://raw.githubusercontent.com/thspanhol/gym-training/main/public/dumbbell.png"
        alt="dumbbell.png"
      ></img>
      ...
      <input
        ...
        id="exe"
        spellCheck="false"
        placeholder="Ex: Cadeira Adutora"
      ...
      <input
        ...
        spellCheck="false"
        placeholder="Ex: 30kg"
        onChange={(e) => setExCar(e.target.value)}
        value={exCar}
      />
      ...
      <button
        onClick={() => {
          editWorkouts(selecionado, {
            ex: exNome,
            rep: exRep,
            car: exCar,
            img:
              exImg === ""
                ? "https://raw.githubusercontent.com/thspanhol/gym-training/main/public/pin-icon.png"
                : exImg,
          });
          setExNome("");
          setExRep("");
